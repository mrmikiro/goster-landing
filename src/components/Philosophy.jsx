    ...
    <section ref={ref} className="py-20 md:py-28 bg-dark-900 overflow-hidden relative">
      ...
      <div className="relative max-w-4xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <p className="fade-up delay-2 mt-4 text-white/40 text-lg font-light max-w-2xl mx-auto">
            De <span className="text-white/70 font-medium">ghost</span>writer nace <strong className="text-white/80">gōster</strong> — la Ō es la H ausente.
            Trabaja en silencio para que el informe hable por ti.
          </p>
        </div>
