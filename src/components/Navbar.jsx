    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button
            onClick={toggle}
            className="text-[13px] font-medium text-white/30 hover:text-white/70 transition-colors duration-300 uppercase tracking-wider"
          >
            {lang === 'es' ? 'EN' : 'ES'}
          </button>
          <a
        ...
        <div className="md:hidden flex items-center gap-3">
          <button
            onClick={toggle}
            className="text-xs font-medium text-white/30 hover:text-white/70 uppercase tracking-wider"
          >
            {lang === 'es' ? 'EN' : 'ES'}
          </button>
          <button
