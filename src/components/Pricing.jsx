...
const plans = [
  {
    ...
    price: '$349',
    period: 'MXN/mes',
    desc: 'Todo lo esencial para digitalizar tu flujo de informes.',
    features: [
  ...
  },
  {
    ...
    price: '$599',
    period: 'MXN/mes',
    desc: 'Mayor capacidad y funciones avanzadas para alta demanda.',
    features: [
